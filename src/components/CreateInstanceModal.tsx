  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-800 rounded-lg border border-gray-700 w-full max-w-2xl max-h-[90vh] overflow-hidden z-50">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-400">Pure Minecraft experience</p>
                    </button>
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-400">Pre-configured mod collection</p>
                    </button>
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-400">Build your own setup</p>
                    </button>
                  </div>
                </motion.div>
              )}
                  ...
                  {instanceType === 'modpack' ? (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-400">{modpack.description}</p>
                    ...
                    <>
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        />
                        <label htmlFor="showSnapshots" className="text-sm text-gray-300">
                      ...
                      <div className="grid grid-cols-2 gap-2 max-h-64 overflow-y-auto">
                        {filteredVersions.map((version) => (
                          ...
                          >
                            ...
                            <div className="text-xs text-gray-400 capitalize">{version.type}</div>
                          </button>
                        ))}
                      </div>
                    </>
                ...
                >
                  ...
                  <div className="bg-gray-700 rounded-lg p-4">
                    ...
                    <div className="space-y-1 text-sm text-gray-300">
                      <p><span className="text-gray-400">Type:</span> {instanceType}</p>
                      {instanceType === 'modpack' && selectedModpack && (
                        <>
                          <p><span className="text-gray-400">Modpack:</span> {selectedModpack.name}</p>
                          <p><span className="text-gray-400">Version:</span> {selectedModpack.version}</p>
                          <p><span className="text-gray-400">Minecraft:</span> {selectedModpack.minecraftVersion}</p>
                        </>
                      )}
                      {instanceType !== 'modpack' && (
                        <p><span className="text-gray-400">Minecraft Version:</span> {selectedVersion}</p>
                      )}
                    </div>
                  </div>
                </motion.div>
